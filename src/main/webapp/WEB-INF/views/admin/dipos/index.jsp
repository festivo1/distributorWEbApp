                ...
                <tbody>
                    <c:forEach var="dipo" items="${dipos}">
                        ...
                        <tr>
                            ...
                            <td> 
                                <a href="${SITE_URL}/dipotransaction/add/${dipo.id}" type= "button" class="btn btn-sm btn-primary ">
                                    <span class="glyphicon glyphicon-plus"></span>
                                </a>
                                <a href="${SITE_URL}/dipo/transaction/edit/${dipo.id}" class="btn btn-default">
